...
export const PAQUETES_TIMBRES: PaqueteTimbre[] = [
  {
    id: "TIMBRES_50",
    nombre: "Paquete 50 Folios EasyConta",
    timbres: 50,
    precio: 149,
    precioUnitario: "2.98",
    popular: false,
    descripcion: "Hoy descuentan el contador interno. El timbrado SAT se enciende al conectar el PAC.",
  },
  {
    id: "TIMBRES_100",
    nombre: "Paquete 100 Folios EasyConta",
    timbres: 100,
    precio: 249,
    precioUnitario: "2.49",
    popular: true,
  ...
  {
    id: "TIMBRES_500",
    nombre: "Paquete 500 Folios EasyConta",
    timbres: 500,
    precio: 799,
    precioUnitario: "1.60",
    popular: false,
  ...
  {
    id: "TIMBRES_1000",
    nombre: "Paquete 1,000 Folios EasyConta",
    timbres: 1000,
    precio: 1399,
    precioUnitario: "1.40",
    popular: false,
